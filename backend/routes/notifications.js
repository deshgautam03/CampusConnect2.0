...
router.get('https://campusconnect2-0-2.onrender.com/', [auth, authorize('faculty')], async (req, res) => {
  try {
...
// @access  Private (Faculty only)
router.get('https://campusconnect2-0-2.onrender.com/:id', [auth, authorize('faculty')], async (req, res) => {
  try {
