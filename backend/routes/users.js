...
// @access  Private
router.get('https://campusconnect2-0-2.onrender.com/profile', auth, async (req, res) => {
  try {
...
// @access  Private
router.put('https://campusconnect2-0-2.onrender.com/profile', [
  auth,
...
// @access  Private
router.put('https://campusconnect2-0-2.onrender.com/change-password', [
  auth,
...
// Get all students
router.get('https://campusconnect2-0-2.onrender.com/students', auth, authorize('faculty'), async (req, res) => {
  try {
...
router.get('https://campusconnect2-0-2.onrender.com/coordinators', auth, authorize('faculty'), async (req, res) => {
  try {
...
// Update user status
router.put('https://campusconnect2-0-2.onrender.com/:id/status', auth, authorize('faculty'), async (req, res) => {
  try {
...
router.post('https://campusconnect2-0-2.onrender.com/faculty', [
  body('name', 'Name is required').not().isEmpty(),
