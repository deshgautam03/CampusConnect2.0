...
// @access  Public
router.post('https://campusconnect2-0-2.onrender.com/register', [
...
// @access  Public
router.post('https://campusconnect2-0-2.onrender.com/login', [
  body('email', 'Please include a valid email').isEmail(),
...
// @access  Public
router.post('https://campusconnect2-0-2.onrender.com/faculty-login', [
  body('email', 'Please include a valid email').isEmail(),
  body('password', 'Password is required').exists()
], async (req, res) => {
  try {
...
// @access  Private
router.get('https://campusconnect2-0-2.onrender.com/me', auth, async (req, res) => {
  try {
