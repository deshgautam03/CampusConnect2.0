...
router.get('https://campusconnect2-0-2.onrender.com/event/:eventId', auth, authorize('faculty', 'coordinator'), async (req, res) => {
  try {
...
router.get('https://campusconnect2-0-2.onrender.com/student/my-applications', auth, authorize('student'), async (req, res) => {
  try {
...
// Submit application
router.post('https://campusconnect2-0-2.onrender.com/', auth, authorize('student'), [
...
router.put('https://campusconnect2-0-2.onrender.com/:id/status', auth, authorize('faculty', 'coordinator'), [
...
router.get('https://campusconnect2-0-2.onrender.com/stats', auth, authorize('faculty'), async (req, res) => {
  try {
